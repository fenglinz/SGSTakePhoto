...
namespace SGSTakePhoto.Infrastructure
{
    ...
    public class HttpClient
    {
        ...
        /// <returns></returns>
        public static HttpResult PostAsync(string strUrl, string postData)
        {
            item = new HttpItem()
            {
                URL = strUrl,//URL     必需项 
        ...
        /// <param name="postData"></param>
        /// <returns></returns>
        public static Task<HttpResult> PostAsync(string strUrl, string postData, string referUrl = "")
        {
            return Task.Factory.StartNew(() => PostAsync(strUrl, postData));
        }
    }
